  ...
  return (
    <div className="flex justify-center items-center h-screen p-4">
      <div className="text-white text-center text-xl md:text-2xl lg:text-3xl max-w-4xl">
        <p className="mb-6">
          This is a project that emulates an health influencer`s web page. The data was obtained from the Perplexity API and its code is available in the page`s repository, which is: {' '}
